...
GreenConnect is a premium, responsive developer social platform built using Laravel 11. It features interactive posts feed, mutual follow connections, user profile managers, support ticket lookups, and a digital gift card trading center.

## Live Local Server
* Local Host: **`http://127.0.0.1:8001`**

## Key Features
* **Developer Feed:** Create, edit, and delete text posts with image attachments. Users can comment on and like posts.
* **Mutual Connections:** A user follow/unfollow mapping engine to build network circles.
